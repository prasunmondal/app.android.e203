...
class DownloadCalculatingSheet(private val context: Context, private val url: String) {
	...
	fun enqueueDownload(view: View) {
		...
		val destination = FileManagers.downloadLink_CalculatingSheet.destination
		...
		request.setTitle("Fetching details data")
